...
def run_test_largest_number():
    ...
    expected = 999
    answer = largest_number(([222], [0], [999]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    expected = -5
    answer = largest_negative_number(([30, -5, 8, -20],[100, -26, 88, -40, -5],[400, 500]))
    print('Expected and actual are:', expected, answer)
    ...
    expected = -10
    answer = largest_negative_number(([0],[-10,2]))
    print('Expected and actual are:', expected, answer)

    expected = -1
    answer = largest_negative_number([(-55,10,99),(-10,-9,-1)])
    print('Expected and actual are:', expected, answer)
